...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_selfcontrol_grup4_exec = my_robot_control.my_robot_selfcontrol_grup4:main',
            ...
            'my_robot_wallfollower_grup4_exec = my_robot_control.my_robot_wallfollower_grup4:main',
